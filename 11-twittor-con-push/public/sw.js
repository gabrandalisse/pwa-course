...
self.addEventListener("push", (e) => {
  ...
  const options = {
    ...
    image:
      "https://cdn-e360.s3-sa-east-1.amazonaws.com/tom-holland-revela-que-sabe-quien-ha-comprado-la-torre-de-los-vengadores-large-ZBszSWH8M0.jpg",
    vibrate: [
...
self.addEventListener("notificationclick", (e) => {
  ...
  // clients es un objeto global que hace referencia a todas las pestañas abiertas
